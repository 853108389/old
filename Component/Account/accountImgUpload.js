...
export default class AccountImgUpload extends Component {
    ...
    _renderAvatarBox(user) {
        // TODO:
        let cell = <Avatar imgUrl={"http://oxnbmu2mx.bkt.clouddn.com/yital_logo.jpg"} avatarStyle={[styles.avatar]} noAvatarStyle={[styles.noAvatar, { backgroundColor: "#eee" }]}></Avatar>
        return cell
    }
    ...
    render() {
        ...
        if (user) {
            if ( user.userBackimg /*true*/) {
                return (
                    <View style={styles.avatarContainer}>
                        <Image style={styles.avatarContainer}
                            //TODO: 
                            source={{ uri: "http://oxnbmu2mx.bkt.clouddn.com/yital_logo.jpg" }}
                        >
                            {cell}
                        </Image>
                    </View>
