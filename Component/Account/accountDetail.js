...
import CommonCellsWithModal from '../oldAdapter/oldCellsWithModal'
import AccountImgUpload from './accountImgUpload'
import Login from '../../login'
import CellWithModal from '../oldAdapter/oldCellsWithModal'
import config from '../common/config'
import request from '../common/request'
import DeviceStorage from '../common/deviceStorage';
import CommonCell from '../oldAdapter/oldCell';
import { fetchUserInfo, asyncGetUser, updateUserInfo } from '../common/fetch'
export default class AccountDetail extends Component {
    ...
    _renderDataCell() {
        ...
        if (data) {
            ...
            dataCell =
                <View>
                    {tempArr}
                    <CommonCellsWithModal params={params} isMulty={true} data={data1} saveCallBack={() => { this._saveCallBack() }}></CommonCellsWithModal>
    ...
    _fetchUpdateUser() {
        ...
        updateUserInfo(this.state.user.userId, params).then().catch((err) => {
